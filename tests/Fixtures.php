<?php
namespace cristianoc72\codegen\tests;
 ...
 */');
    ...
    {
        return PhpClass::create('cristianoc72\\codegen\\tests\\fixtures\\ClassWithConstants')
    ...
    {
        return PhpClass::create('cristianoc72\\codegen\\tests\\fixtures\\ClassWithTraits')
            ->addUseStatement('cristianoc72\\codegen\\tests\\fixtures\\DummyTrait', 'DT')
            ->addTrait('DT');
    }
    ...
    {
        $class = PhpClass::create('cristianoc72\\codegen\\tests\\fixtures\\ClassWithComments');
    ...
    public static function createDummyInterface()
    {
        $interface = PhpInterface::create('DummyInterface')
            ->setNamespace('cristianoc72\codegen\tests\fixtures')
